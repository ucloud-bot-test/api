...
| **ProjectId** | integer | 项目ID。不填写为默认项目，子帐号必须填写。 请参考[GetProjectList接口](api/summary/get_project_list) |No|
| **HostId** | string | 资源池的短ID |**Yes**|
| **Memory** | integer | 内存大小, 单位: MB, 范围[65536，163840], 步长: 32768, 默认值: 131072 |No|
| **DiskSpace** | integer | 数据盘大小, 单位: GB, 范围[4096,6144], 步长: 2048, 默认值: 6144 |No|
